        ...
        !async function() {
            if (window == top) {
                ...
                if (e.setAttribute("type", "text/javascript"), e.textContent = `window.__CHROME_UI_LANG__ = "${chrome.i18n.getUILanguage()}";`, e.onload = () => {
                    ...
                    let e = localStorage.getItem("earlyBird_code_netflix");
                    if (e) {
                    ...
                    let t = {
                            https: !0,
                            subdomain: "extension",
                            path: "500/pageScript_lln.min.js",
                            params: {},
                            parseAs: "text"
                        },
                        n = await Object(o.a)({
                    ...
                    localStorage.setItem("earlyBird_code_netflix", n.data), e ? e && e.length !== n.data.length && location.reload() : location.reload()
                }
            }
        }()
    },
